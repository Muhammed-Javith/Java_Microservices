...
public class SwaggerDocConfig {
	...
	public OpenAPI openAPI() {
		...
		Info information = new Info().title("Employer Management System API").version("v1.0")
				.description("This API exposes endpoints to manage  Employee_Work Profile Microservice.").contact(myContact)
